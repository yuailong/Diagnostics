...
namespace HealthChecksSample
{
    ...
    public class DetailedStatusStartup
    {
        ...
        {
            // This will register the health checks middleware at the URL /health (default)
            // 
            // This example overrides the HealthCheckResponseWriter to include a detailed
            ...
            {
                ResponseWriter = new DetailedJsonHealthCheckResponseWriter(),
            });
